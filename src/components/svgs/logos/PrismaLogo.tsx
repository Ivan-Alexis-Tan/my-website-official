...
export default function PrismaLogo({ className, title = true }: SVGComponentProps) {
    return (
        <svg className={className ?? ""} viewBox="0 0 256 310" width="256" height="310" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
            {title && <title>{title === true ? "Prisma" : title }</title>}
