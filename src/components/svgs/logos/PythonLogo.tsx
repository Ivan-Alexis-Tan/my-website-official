...
export default function PythonLogo({ className, title = true }: SVGComponentProps) {
    return (
        <svg className={className ?? ""} width="800px" height="800px" viewBox="0 0 32 32" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            {title && <title>{title === true ? "Python" : title }</title>}
